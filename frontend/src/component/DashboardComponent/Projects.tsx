        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {projects.map((proj) => (
            <div
              ...
              className="flex flex-col justify-between rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition hover:shadow-md cursor-pointer"
            >
              <div>
                {/* Header Row */}
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span
                    className={`rounded-full border px-2.5 py-0.5 text-xs font-medium capitalize ${getStatusStyle(
                      proj.status,
                    )}`}
                  >
                    {proj.status}
                  ...
                  <span
                    className={`rounded-full border px-2.5 py-0.5 text-xs font-medium capitalize ${getPriorityStyle(
                      proj.priority,
                    )}`}
                  >
